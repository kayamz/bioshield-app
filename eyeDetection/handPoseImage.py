...
def detect_fingerPoint(inputImage) :
    ...
    protoFile = os.path.dirname(os.path.realpath(__file__))+'/hand/pose_deploy.prototxt'
    weightsFile = os.path.dirname(os.path.realpath(__file__))+'/hand/pose_iter_102000.caffemodel'
    nPoints = 22
